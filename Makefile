...
.PHONY: all clean whisper setup build local update-install install-weekly-updater uninstall-weekly-updater check healthcheck help dev run release release-setup
